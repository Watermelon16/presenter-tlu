  ...
  const tools: Tool[] = [
    {
      ...
      desc: "Nêu chủ đề + phần tập trung. Sinh câu hỏi, lựa chọn, đáp án + nhiễu (poll/wordcloud/rating/opentext/board/Q&A)",
      needsKey: true,
    ...
    },
    {
      ...
      desc: hasPdf ? "Chọn slide range + chủ đề trọng tâm. Sinh 5-10 hoạt động bám sát slide" : "Cần upload PDF trước",
      needsKey: true,
      disabled: !hasPdf,
    ...
    },
    {
      ...
      desc: "Sinh chuỗi 3-5 câu hỏi khảo sát SV (cảm nhận, hiểu biết, mong muốn)",
      needsKey: true,
    ...
    },
    {
      ...
      desc: "Phân tích responses + Q&A + board → insight: hiểu rõ / nhầm / câu hỏi đáng chú ý / gợi ý buổi sau",
      needsKey: true,
