...
// Internal query — gọi từ action summarizeSession trong ai.ts.
...
export const getSessionSnapshot = internalQuery({
  ...
  handler: async (ctx, args) => {
    ...
    // Đóng gói activity với responses của nó
        ...
        if (a.type === "poll") {
          ...
          detail = {
            answers: resps
              ...
              .filter(Boolean)
              .slice(0, 50),  // cap để prompt không quá dài
          };
